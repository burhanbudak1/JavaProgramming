...
public class ArraysUtility {
    ...
    // replace the elements of the array at given index with new element, and returns the new array.
    ...
    // removes the duplicates from given array, and returns the new array
